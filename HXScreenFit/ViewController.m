...
- (void)setup {
    ...
    // 调整字号
    CGFloat redLabelFontSize = HXScreenFitUtil.ScreenFit.iphone4(10).iphone5(15).iphone6(25).iphone6p(30).iphoneX(35).iphoneXSMax(40).defaultValue(45);
    self.redLabel.text = [NSString stringWithFormat:@"字号 : %0.f, 高度 : %f",redLabelFontSize,self.labelHeightCons.constant];

    // 调整 frame
    CGFloat yellowLabelHeight = HXScreenFitUtil.ScreenFit.iphone4(10).iphone5(50).iphone6(99).iphone6p(150).iphoneX(200).iphoneXSMax(250).defaultValue(60);
